    ...
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen w-full bg-background relative flex">
        ...
        <div className="relative z-10 flex-1 flex flex-col w-full">
          <header className="sticky top-0 z-50 h-16 border-b border-border/40 bg-background/80 backdrop-blur-xl flex items-center px-4 gap-4">
            <SidebarTrigger className="hover:bg-primary/10 rounded-lg p-2 transition-all duration-300" />
